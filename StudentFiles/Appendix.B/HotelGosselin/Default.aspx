                                        ...
                                        <table style="width: 60%">
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:ImageButton ID="leftButton" runat="server" ImageUrl="images/left.gif" OnClick="leftButton_Click" /><asp:Image
                                                        ID="roomImage" runat="server" ImageUrl="images/suite1.jpg" /><asp:ImageButton ID="rightButton"
                                                            runat="server" ImageUrl="images/right.gif" OnClick="rightButton_Click" />
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
