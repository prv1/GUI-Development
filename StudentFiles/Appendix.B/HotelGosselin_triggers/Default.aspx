                        ...
                        <div id="content1-2-1-1-3" align="center">
                            ...
                            <div>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="leftButton" />
                                        <asp:AsyncPostBackTrigger ControlID="rightButton" />
                                    </Triggers>
                                    <ContentTemplate>
                                ...
                                <asp:ImageButton ID="leftButton" runat="server" ImageUrl="images/left.gif" OnClick="leftButton_Click" />&nbsp;
                                <asp:ImageButton ID="rightButton" runat="server" ImageUrl="images/right.gif" OnClick="rightButton_Click" />
                            </div>
                            </form>
                        </div>
                    </div>
