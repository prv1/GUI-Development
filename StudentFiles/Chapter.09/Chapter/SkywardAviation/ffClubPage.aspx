<%@ Page Language="C#" Debug="true" AutoEventWireup="true" CodeFile="ffClubPage.aspx.cs"
    Inherits="_Default" %>
                                                            ...
                                                            <td>
                                                                <div class="c3">
                                                                    <table width="168" border="0" align="right" cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            <td>
                                                                                <img src="images/spic_003.jpg" width="168" height="209" alt="Visual formatting image" />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td height="30" valign="top">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="100%" height="50" bgcolor="#DADADA" class="whiteline">
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="6">
                                                                                                <tr>
                                                                                                    <td class="promotext">
                                                                                                        Skyward offers rail service from Paris to cities within France.
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </td>
